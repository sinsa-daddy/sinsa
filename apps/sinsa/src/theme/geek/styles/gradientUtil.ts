...
export const getBackground = (lineWidth = 0) => ({
  background,
...
export const getAnimationBackground = (lineWidth = 0): CSSObject => ({
...
export const getBackgroundAnimation = (lineWidth = 0) => {
...
export const getBorderStyle = (lineWidth = 0): CSSObject[] => [
  {
    content: '""',
    position: 'absolute',
    inset: -lineWidth,
